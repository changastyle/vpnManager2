<div id="botonera" class="row col-xs-12">
    ...
    <!--BOTONES:-->
    <button class="btn btn-success" data-toggle="modal" data-target="#modalModems" style='margin-top: 12px;margin-bottom: 12px;' ng-click="pedirUsuarioSugerido()"><span class="glyphicon glyphicon-plus"></span> Agregar Nuevo Modem</button>
